...
class SettingsDialog:
    ...
    def __init__(self, parent, current_config, app_dir, on_readme=None):
        ...
        self.subtitle_font_var = tk.IntVar(value=int(cfg.get('subtitle_font_size', 128)))
        ...
        tk.Spinbox(grp_sub, from_=20, to=160, textvariable=self.subtitle_font_var, width=6).grid(row=r, column=1, sticky='w', **_PAD)
